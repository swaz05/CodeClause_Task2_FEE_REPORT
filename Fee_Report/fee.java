...
public class fee extends Frame {
    ...
    fee()
    {
        ...
        rb1 = new JRadioButton("G1");
        rb1.setBounds(550, 150, 100, 30);


        rb2 = new JRadioButton("G2");
        ...
        li1.addElement("CSE(2, 70, 500)");
        li1.addElement("IT(2, 70, 500)");
        li1.addElement("EEE(2, 70, 500)");
        li1.addElement("MECH(2, 70, 500)");
        li1.addElement("CIVIL(2, 70, 500)");
